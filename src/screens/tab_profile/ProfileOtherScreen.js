...
const ic_Live = require('../../assets/images/ic_tab_camera.png');
const ic_Photo = require('../../assets/images/ic_tab_camera.png');
const ic_Room = require('../../assets/images/ic_tab_camera.png');
...
class ProfileOtherScreen extends React.Component {
  ...
  _renderLike = () => {
    ...
    const options = [
      {
        label: 'Live (' + dislikeCount + ')',
        value: '0',
        imageIcon: ic_Live,
      },
      {label: 'Photo', value: '1', imageIcon: ic_Photo,},
      // {label: 'Like (' + likeCount + ')', value: '2', imageIcon: ic_like},
      {label: 'Room', value: '1', imageIcon: ic_Room,},
    ];
